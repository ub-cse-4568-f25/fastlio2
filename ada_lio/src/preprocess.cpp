...
Preprocess::Preprocess()
  : feature_enabled(0), lidar_type(AVIA), blind(0.01), blind_for_human_pilots(1.5), point_filter_num(1) {
  inf_bound         = 10;
  N_SCANS           = 6;
  SCAN_RATE         = 10;
  group_size        = 8;
...
void Preprocess::process(const sensor_msgs::PointCloud2::ConstPtr &msg, PointCloudXYZI::Ptr &pcl_out) {
  switch (time_unit) {
    case SEC:time_unit_scale = 1.e3f;
      break;
    case MS:time_unit_scale = 1.f;
      break;
    case US:time_unit_scale = 1.e-3f;
      break;
    case NS:time_unit_scale = 1.e-6f;
      break;
    default:time_unit_scale = 1.f;
      break;
  }
  ...
  switch (lidar_type) {
    ...
    default:printf("Error LiDAR Type");
      break;
  }
  *pcl_out = pl_surf;
}
